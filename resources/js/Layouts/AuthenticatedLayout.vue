...
<template>
    <div class="min-h-screen">
        <div :class="{ 'relative hidden z-50 lg:flex lg:fixed lg:w-60': !sidebarOpen }" class="relative z-50 h-full lg:flex lg:fixed lg:w-60">
        ...
        <div class="lg:pl-60">
            ...
            <main class="py-6">
                <div class="px-4 sm:px-6">
                    ...
                    <div class="flex justify-start pb-1 mb-4 border-b border-primary-600">
